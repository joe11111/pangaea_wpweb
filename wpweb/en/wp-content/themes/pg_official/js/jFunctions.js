...
//	$(".menu-main-navi-container").find(".menu-item").find("a").find("div").addClass("navi-text");
}
//サイドナビゲーションにクラス追加
...
function setupMainNaviTextCenter(){
	for(var i=0;i < $(".menu-main-navi-container").find(".menu-item").find("a div div").length;i++){
		...
		var cHeight =$(".menu-main-navi-container").find(".menu-item").find("a div div").eq(i).height()/2;
		$(".menu-main-navi-container").find(".menu-item").find("a div div").eq(i)
			.css("position","relative")
			.css("margin-top", pHeight - cHeight);
	}
}
//サイドナビゲーションボタンのCSS変更
